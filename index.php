    ...
    <body>
        ...
        <section id="competence">
            ...
            <div class="divContainerComp">
                <div class="html icon fade" title="HTML"><img src="img/icon/html.png" alt="Icône du logo html"></div>
                <div class="css icon fade" title="CSS"><img src="img/icon/css.png" alt="Icône du logo css"></div>
                <div class="jquery icon fade" title="JQuery"><img src="img/icon/jQurery.png" alt="Icône du logo jquery"></div>
                <div class="js icon fade" title="JavaScript"><img src="img/icon/javaScript.png" alt="Icône du logo javaScript"></div>
                <div class="php icon fade" title="PHP"><img src="img/icon/php7.png" alt="Icône du logo php" ></div></a>
                <div class="bootstrap icon fade" title="Bootstrap"><img src="img/icon/bootstrap.png" alt="Icône du logo bootstrap" ></div>
        ...
        <section id="realisation">
            ...
            <div class="divRealCont">
                ...
                <div class="card sncfDiv fade">
                    ...
                    <h3>SNCF</h3>
                    <p>Réalisation d’une application visant à regrouper plusieurs logiciels sur une seule interface. Le but est de rendre l'interface plus ergonomique et de réduire le temps d'éxecution des manipulations demandé par les nombreux logiciels.</p>
                </div>
